 ...
 * [cao.yml](cao.yml)
     * Determines how your purl.obolibrary.org/obo/cao/ redirects will be handled
     ...
     * Paste in the contents of [cao.yml](cao.yml)
 ...
 * [cao.md](cao.md)
     ...
     * Paste in the contents of [cao.md](cao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
